...
class Business: NSObject {
    ...
    class func search(with term: String, offset: Int?, sort: YelpSortMode?, categories: [String]?, deals: Bool?, completion: @escaping ([Business]?, Error?) -> ()) -> () {
        YelpClient.shared().search(with: term, offset: offset, sort: sort, categories: categories, deals: deals, completion: completion)
    }
}
